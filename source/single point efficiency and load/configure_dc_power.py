...
def perform_measurements(
    ...
    load_current = abs(load_measurement.current)
    load_voltage = load_measurement.voltage
    efficiency = abs((load_voltage*load_current*100) / (source_measurement.voltage*source_measurement.current))
    load_voltage_deviation = ((load_voltage - nominal_output_voltage)/nominal_output_voltage)*100

    return (load_current, load_voltage, efficiency, load_voltage_deviation)